...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <custom>true</custom>
    <description>This profile is for employees that assist with the sales cycle, but also need access to consulting information as well for a 360 degree view of an account.  Includes, Engagement Managers, Client Partners, Solution Architects, and Technical Architects.</description>
    <fieldPermissions>
