...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <custom>true</custom>
    <description>Special user that is restricted to API-only access, and can be used by applications that need to integrate to data in our SFDC org.  These apps should be documented on the &quot;Things That Log In To our SFDC Production System Via API&quot; wiki page.</description>
    <fieldPermissions>
